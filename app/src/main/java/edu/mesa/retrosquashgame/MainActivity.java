...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        racketPosition2.x = screenWidth / 2;
        racketPosition2.y = screenHeight - 1700;
        racketWidth2 = screenWidth / 8;
        racketHeight2 = 10;
    ...
    class SquashCourtView extends SurfaceView implements Runnable {
        ...
        public void updateCourt() {
            ...
            //can't pass right of screen
            if (racketPosition.x + ballWidth > screenWidth) {
                racketIsMovingRight = false;
                racketIsMovingLeft = true;
                soundPool.play(sample1, 1, 1, 0, 0, 1);
            }

            //can't pass left of screen
            ...
            if (ballPosition.y + ballWidth <= (racketPosition2.y)) {
                int racketHalf = racketWidth2 / 2;
                if (ballPosition.x + ballWidth < (racketPosition2.x + racketHalf)
                        && ballPosition.x - ballWidth < (racketPosition2.x + racketHalf)) {
                    //rebound the ball and play a sound
                    soundPool.play(sample3, 1, 1, 0, 0, 1);
                    ...
                    ballIsMovingDown = true;
                    //now decide how to rebound the ball
                    if (ballPosition.x < racketPosition2.x) {
                        ballIsMovingRight = true;
                        ballIsMovingLeft = false;
        ...
        public void drawCourt() {
            ...
            if (ourHolder.getSurface().isValid()) {
                ...
                canvas.drawRect(racketPosition2.x - (racketWidth / 2),
                        racketPosition2.y - (racketHeight / 2), racketPosition2.x + (racketWidth / 2),
                        racketPosition2.y + racketHeight, paint);
                racketPosition2.x = ballPosition.x;
